"""
A list of tuples of the expanded I94 port information from I94_SAS_Labels_Descriptions.SAS.
Contains the Port code, city, and state/country.
"""
I94PORT = [
   ('ALC','ALCAN','AK'),
   ('ANC','ANCHORAGE','AK'),
   ...
   ('SVC','GRANT COUNTY - SILVERCITY','MN'),
   ('INT','INT''L FALLS','MN'),
   ('LAN','LANCASTER','MN'),
   ('MSP','MINN./ST PAUL','MN'),
